...
//         
            ...
            let tickIcon = '<div class = "icon tick"><img src="svgs/tick.svg" alt="✔️"></div>'
            // <i class="bx bx-check - circle"></i>
            let crossIcon = '<div class = "icon wrong"><img src="svgs/cross.svg" alt="❌"></div>';
...
//  
          ...
          if(userScore == questions.length){
               let scoreTag = '<span>Perfect!! you got<p>'+userScore +'</p>out of<p>'+ questions.length +'</p>questions</span>'
               scoreText.innerHTML = scoreTag;
            }
            else  if(userScore > 6 ){
               let scoreTag = '<span>Congrats! you got<p>'+ userScore +'</p>out of<p>'+ questions.length +'</p>questions</span>'
               scoreText.innerHTML = scoreTag;
            }
            else if(userScore > 3){
               let scoreTag = '<span>Nice, you got<p>'+userScore +'</p>out of<p>'+questions.length +'</p>questions</span>'
               scoreText.innerHTML = scoreTag;
            }
            else{
               let scoreTag = '<span>Sadly, you got<p>'+userScore +'</p>out of<p>'+ questions.length +'</p>questions</span>'
               scoreText.innerHTML = scoreTag;
             }
             };
//
...
//           
             ...
             const bottomQueCount = quizBox.querySelector(".total-questions");
                ...
                let totalQuestionsCount = '<span><p>' + index + ' of</p><p>' + questions.length + ' Questions</p></span>';             
